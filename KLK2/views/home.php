...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <!-- columna 1 fila 1 -->
            <div class="col" style="background-color: #5a5e9a; z-index:3;">
            ...
            <div class="row">
                <!-- columna 1 fila 2 -->
                <div class=" col-xs-12  col-sm-12  col-md-3 col-lg-3" style="padding-top: 10px;">
                    <section class="hero">
                        <div class="hero-content">
                            <h6>Comparte lo que quieras</h6>
                            <p>con KLK</p>
                            <div class="text-center my-4">
                                <button id="mostrarFormulario" class="btn butt ">Subir Foto</button>
                            </div>

                            <!-- Formulario oculto -->
                            <div id="formularioFoto" class="container" style="display: none;">
                                <form id="formFoto" enctype="multipart/form-data" class="p-3 border rounded shadow-sm bg-light">
                                    <div class="mb-3">
                                        <label for="foto" class="form-label" style="color: #5a5e9a;">Selecciona una foto:</label>
                ...
                <div class=" col-xs-12  col-sm-12  col-md-6 col-lg-6">
                    <div class="container">
                            <div id="galeria" class="row g-6"></div>
                    </div>
                    <div id="comments-${foto.id}" class="mt-2 text-start" style="display:none; color: #ffffff; "></div>
